...
// const patientview=require("./viewPatient");
...
// router.use("/patient_view",patientview );
...
router.use("/viewpatient",viewpatient);
router.use("/listpatient",listpatient);
router.use("/addbilling",addbilling);
router.use("/listbilling",listbilling);
router.use("/listgeneral",listgeneral);
router.use("/listdermotology",listdermotology);
router.use("/listorthopedics",listorthopedics);
router.use("/listpediatrics",listpediatrics);
