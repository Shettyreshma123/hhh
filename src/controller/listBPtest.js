...
router.get("/", authenticate, async (req, res) => {
  try {
    const testtype = "BloodPressureTest"; // You can set this dynamically based on user input

    // Convert the testtype value to lowercase
    const lowercaseTestType = testtype.toLowerCase();

    // Define accepted test type variations
    const acceptedTestTypes = ["bloodpressuretest", "bptest", "bloodpressuretest","BPTest","BPtest"];
