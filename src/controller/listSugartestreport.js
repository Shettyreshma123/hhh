...
const titleText1 = "Sugar Level Test Report";
...
doc.moveDown(1);
    ...
    const tableData = [
        ...
        ["Postprandial Blood Sugar", patient.postPrandialBloodSugar],
        ["Random Blood Sugar", patient.randomBloodSugar],
        ["HbA1c", patient.hba1c],
        ["Oral Glucose Tolerance Test", patient.oralGlucoseToleranceTest],
        ["Fructosamine", patient.fructosamine],
        ["C-Peptide Test", patient.cPeptideTest],
        ["Insulin Level", patient.insulinLevel],
        ["Urine Ketones", patient.urineKetones],
